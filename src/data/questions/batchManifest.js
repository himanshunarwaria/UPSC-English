...
export const BATCH_MANIFEST = [
  ...
  { batchNo: 3,  file: 'batch_003_sentence_correction.js',    category: 'Sentence Correction',      targetCount: 100, difficultyMix: 'B1:15 B2:35 C1:40 C2:10', status: 'pending', generatedCount: 0, validated: false, notes: '' },
  { batchNo: 4,  file: 'batch_004_sentence_correction.js',    category: 'Sentence Correction',      targetCount: 100, difficultyMix: 'B1:15 B2:35 C1:40 C2:10', status: 'pending', generatedCount: 0, validated: false, notes: '' },

  // Subject-Verb Agreement — 1 batch (100 questions)
  { batchNo: 5,  file: 'batch_005_subject_verb_agreement.js', category: 'Subject-Verb Agreement',   targetCount: 100, difficultyMix: 'B1:15 B2:35 C1:40 C2:10', status: 'pending', generatedCount: 0, validated: false, notes: '' },
